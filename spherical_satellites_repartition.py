...
def spherical_satellites_repartition(N_satellites, cities_coordinates, cities_weights, scope = 15, height = 4):
...
def solve_3D(cities_coordinates, cities_weights, scope = 15, height = 4):
    num_cities = cities_coordinates.shape[0]
