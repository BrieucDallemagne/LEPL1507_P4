...
def test_solve_2D_random( n_tests=10):
    for i in range(n_tests):
        ...
        satellites_coordinates = esr.euclidean_satellites_repartition(number_of_satellites, cities_coordinates, poids, grid_size, scope, height)
        pp.plot_covering_2D(cities_coordinates, poids, satellites_coordinates)
        plt.show()


def test_special_cases():
    # Test de la fonction euclidean_satellites_repartition pour des cas particuliers
    # Cas 1: limites de la version discrete
    cities_coordinates = np.array([[0, 0],[0,1]])
    radius = 0.95
    number_of_satellites = 1
    satellites_coordinates = esr.euclidean_satellites_repartition(number_of_satellites, cities_coordinates, [0.8,0.2], 2, scope = 1, height = 0.05)
    ...
    radius = 1
    number_of_satellites = 1
    satellites_coordinates = esr.euclidean_satellites_repartition(number_of_satellites, cities_coordinates, [0.5,0.5], 2, scope=1, height=0)
    ...
    radius = 2
    number_of_satellites = 1
    satellites_coordinates = esr.euclidean_satellites_repartition(number_of_satellites, cities_coordinates, [0.1,0.01,0.09,0.4,0.4], 5, scope = 2, height = 0)
    ...
    radius = 1
    number_of_satellites = 1
    satellites_coordinates = esr.euclidean_satellites_repartition(number_of_satellites, cities_coordinates, [0.25,0.25,0.25,0.25], 5, scope = 1, height = 0)
    ...
    satellites_coordinates = esr.euclidean_satellites_repartition(number_of_satellites, cities_coordinates, [0.25,0.25,0.25,0.25], 5, scope = 1 , height = 0.7)
    pp.plot_covering_2D(cities_coordinates, [0.25,0.25,0.25,0.25], satellites_coordinates, 5)
    ...
    satellites_coordinates = esr.euclidean_satellites_repartition(number_of_satellites, cities_coordinates, [1], 5, scope = 1, height = 0)
...
def big_test():
    ...
    satellites = esr.euclidean_satellites_repartition(number_of_satellites, cities, poids, grid_size, scope, height, intensity=1000)
